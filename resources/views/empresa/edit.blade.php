...
@section('content')
    <div class="panel">
        ...
        <h1>{{$empresa->name}}</h1>
            <p>Formulário de edição de registro</p>
        <hr/>

    {!! Form::model($empresa, ['method' => 'PATCH', 'action' => ['EmpresaController@update', $empresa->id],'class' => 'form-horizontal','files' => true]) !!}
            @if ($errors->any())
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-sm-3">
                    {!! $empresa->logo ? '<img width="150px" src="'.asset("uploads/empresas/$empresa->logo").'">' : null !!}
                    {!! Form::file('logo', null) !!}
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-6">
                        <div class="input-group padding5">
                            ...
                            {!! Form::select('subcategoria_id', $subcategorias, null, array('class' => 'form-control','id' => 'subcategoria_id')) !!}
                            <span class="input-group-btn">
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="input-group padding5">
                    ...
                    {!! Form::select('estado_id', $estados, null, array('placeholder' => 'Selecione','class' => 'form-control','id' => 'estado_id','onChange' => 'getCitys()')) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group padding5 cidades">
                    <span class="input-group-addon">Cidade:</span>
                    {!! Form::select('cidade_id', $cidades, null, array('placeholder' => 'Selecione','class' => 'form-control','id' => 'cidade_id','onChange' => 'getAll()')) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="input-group padding5 ceps">
                    <span class="input-group-addon">CEP:</span>
                    {!! Form::select('cep_id', $ceps, null, array('placeholder' => 'Selecione','class' => 'form-control','id' => 'cep_id')) !!}
                    <span class="input-group-btn">
            ...
            <div class="col-md-6">
                <div class="input-group padding5 logradouros">
                    <span class="input-group-addon ">Rua:</span>
                    {!! Form::select('logradouro_id', $logradouros, null, array('placeholder' => 'Selecione','class' => 'form-control','id' => 'logradouro_id')) !!}
                    <span class="input-group-btn">
            ...
            <div class="col-md-4">
                <div class="input-group padding5 bairros">
                    <span class="input-group-addon">Bairro:</span>
                    {!! Form::select('bairro_id', $bairros, null, array('placeholder' => 'Selecione','class' => 'form-control','id' => 'bairro_id')) !!}
                    <span class="input-group-btn">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-2">
                    <div class="input-group ">
                        {!! Form::text('active', $empresa->active, ['class' => 'form-control activeEmpresa','style'=>'display:none']) !!}
                        <div class="col-sm-6">
